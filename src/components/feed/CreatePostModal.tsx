        ...
        {view === "compose" && (
          <div className="p-5 flex flex-col gap-4 max-h-[70vh] overflow-y-auto">
            ...
            <div className="relative">
              ...
              {emojiOpen && (
                <div className="absolute right-0 top-10 z-10 w-[360px] max-h-[280px] overflow-y-auto vk-card p-3 bg-popover border-border shadow-xl">
        ...
        {view === "settings" && (
          <div className="p-4 max-h-[70vh] overflow-y-auto flex flex-col gap-1">
            ...
            <div className="relative">
              ...
              {audienceOpen && (
                <div className="absolute left-0 right-0 mt-1 z-10 vk-card p-2 bg-popover border-border shadow-xl">
