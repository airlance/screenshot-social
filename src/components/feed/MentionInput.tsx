...
export const DEFAULT_MENTION_USERS: MentionUser[] = [
  { id: "u1", name: "Skylar Reeves", handle: "skylar", avatar: avatar1, subtitle: "Дизайнер" },
  { id: "u2", name: "Mira Donovan", handle: "mira", avatar: avatar2, subtitle: "Фотограф" },
  { id: "u3", name: "Mark Roberts", handle: "mark", avatar: avatarMe, subtitle: "Это вы" },
