...
const Analytics = () => {
  return (
    <AppLayout variant="wide">
      <section className="vk-card overflow-hidden rounded-xl border border-border/70">
        <header className="flex items-center justify-between border-b border-border px-5 py-4">
          <div className="flex items-center gap-4">
            <img src={avatarMe} alt="Mark Roberts" className="h-11 w-11 rounded-full object-cover" />
            <h1 className="text-2xl font-bold">Mark Roberts</h1>
          </div>
          <div className="flex items-center gap-4 text-muted-foreground">
            <HelpCircle className="h-4 w-4" />
            <Download className="h-4 w-4" />
            <button className="vk-pill gap-2 rounded-lg border border-border bg-transparent py-1.5 text-foreground hover:bg-secondary">
