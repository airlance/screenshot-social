...
const videos = [
  { title: "Эскорт — гламур или ад? Психолог раскрывает правду", author: "Вероника Степанова Психолог", views: "71,4 тыс просмотров", date: "1 день назад", duration: "35:55", image: postPhoto1, avatar: avatar1, verified: true },
  { title: "Быстрые свидания #39. Мария.", author: "Мэтч", views: "4,1 млн просмотров", date: "24 дня назад", duration: "1:33:38", image: postMusicCover, avatar: avatar2, verified: true },
  { title: "Мультики для запуска речи — большой сборник", author: "Цветняшки | развивающий сериал-мюзикл", views: "84,5 тыс просмотров", date: "8 дней назад", duration: "36:51", image: story1, avatar: avatar3, verified: true },
  { title: "КСТАТИ #100 — Toxi$, Любовь Успенская и Kiliana", author: "VK Видео", views: "8,3 млн просмотров", date: "27 дней назад", duration: "1:37:00", image: postVideoThumb, avatar: avatar4, verified: true },
  { title: "Мы опять взяли Range Rover...", author: "Ильдар Авто-Подбор", views: "1,4 млн просмотров", date: "7 дней назад", duration: "1:16:30", image: postPhoto4, avatar: avatar5 },
  { title: "ЛПШКИ | «Популярность — это удача?»", author: "ТОП", views: "1,4 млн просмотров", date: "11 дней назад", duration: "57:29", image: photo1, avatar: avatar6, verified: true },
  { title: "Почему быть несчастливым выгодно?", author: "Марк Бартон", views: "51,5 тыс просмотров", date: "7 дней назад", duration: "1:54:22", image: postPhoto2, avatar: avatar7, verified: true },
  { title: "Мы с Василисой стали моделями! Разрисовали папу", author: "Кукояки", views: "225 тыс просмотров", date: "21 день назад", duration: "26:09", image: postPhoto3, avatar: avatar1, verified: true },
  { title: "Дубай, полиция и один неожиданный день", author: "Travel Show", views: "918 тыс просмотров", date: "3 дня назад", duration: "42:18", image: avatar2, avatar: avatar2 },
  { title: "Новый выпуск: музыка, тренды и закулисье", author: "ХАННА", views: "302 тыс просмотров", date: "сегодня", duration: "18:44", image: avatar6, avatar: avatar6, verified: true },
  { title: "Истории старого города: тайные маршруты", author: "Urban Lab", views: "66 тыс просмотров", date: "5 дней назад", duration: "28:10", image: postPhoto2, avatar: avatar3 },
  { title: "Большой разговор про технологии", author: "Tech Media", views: "412 тыс просмотров", date: "9 дней назад", duration: "1:08:03", image: postVideoThumb, avatar: avatar4, verified: true },
];

const Video = () => (
  <AppLayout variant="wide">
    <section className="vk-card rounded-xl border border-border/70 p-5">
        ...
        {videos.map((video) => (
          <article key={video.title} className="group min-w-0">
            <div className="relative aspect-video overflow-hidden rounded-lg bg-secondary">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-background/55 via-transparent to-transparent opacity-80" />
