...
const Services = () => {
            ...
            <div className="vk-card overflow-hidden rounded-xl p-3">
              <div className="flex gap-3 overflow-x-auto scrollbar-none">
                {banners.map((b, i) => (
                  <div
                    key={i}
                    className="relative h-[260px] w-[420px] shrink-0 overflow-hidden rounded-xl p-6 text-white"
                    style={{ background: b.bg }}
                  >
                    <h2 className="max-w-[240px] text-2xl font-bold leading-tight drop-shadow">{b.title}</h2>
  ...
  return (
    <AppLayout variant="wide">
      <section className="vk-card rounded-xl p-3">
