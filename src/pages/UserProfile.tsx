...
const FALLBACK_AVATARS = [avatar1, avatar2, avatar3, avatar4, avatar5, avatar6, avatar7];
  ...
  return (
    ...
    >
      ...
      <section className="vk-card overflow-hidden rounded-xl">
        <div className="h-[228px] bg-[radial-gradient(circle_at_70%_20%,hsl(var(--foreground)/0.05),transparent_24%),linear-gradient(135deg,hsl(var(--secondary)),hsl(var(--background)))]" />

        <div className="relative flex min-h-[120px] items-start gap-4 bg-card px-5 pb-5 pt-4">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onAddFriend}
              className={`vk-pill rounded-lg px-5 ${
