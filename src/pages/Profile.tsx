      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[1280px] mx-auto px-4 flex gap-4">
          ...
          <main className="flex-1 min-w-0 py-3 flex flex-col gap-3">
            ...
            {/* ── Шапка профиля — на всю ширину правой части ── */}
            <div className="overflow-hidden rounded-xl vk-card">
              {/* Обложка */}
              <div className="relative h-[200px] bg-[radial-gradient(circle_at_70%_20%,hsl(var(--foreground)/0.05),transparent_24%),linear-gradient(135deg,hsl(var(--secondary)),hsl(var(--background)))]">
                <DropdownMenu open={coverMenuOpen} onOpenChange={setCoverMenuOpen}>
                  <DropdownMenuTrigger asChild>
                    <button className="vk-pill absolute right-5 top-5 gap-2 bg-background/80 px-4 py-2 text-sm backdrop-blur hover:bg-background/90">
              ...
              {/* Аватар + имя + кнопки */}
              <div className="relative flex min-h-[88px] items-center gap-4 bg-card px-5 py-4">
                ...
                <div className="ml-[148px] min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <button className="vk-pill gap-2 rounded-lg px-4">Ещё <ChevronDown className="h-4 w-4" /></button>
                    </DropdownMenuTrigger>
            ...
            <div className="flex gap-4">
              ...
              {/* Правая колонка */}
              <aside className="hidden xl:flex flex-col w-[280px] shrink-0 gap-3 sticky top-[72px] self-start max-h-[calc(100vh-72px)]">
