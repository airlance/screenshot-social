...
const GameCover = ({ game }: { game: Game }) => (
  <div
    className={`relative aspect-[4/3] rounded-2xl bg-gradient-to-br ${game.cover} overflow-hidden cursor-pointer group`}
  >
...
const QuickGame = ({ game }: { game: Game }) => (
  <div className="flex flex-col items-center gap-2 w-[80px] shrink-0 cursor-pointer">
    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${game.cover} flex items-center justify-center text-white font-bold text-xl`}>
      {game.title.charAt(0)}
    </div>
...
const FeaturedBanner = () => (
  <div className={`relative aspect-[16/9] md:aspect-[21/9] rounded-2xl bg-gradient-to-br ${FEATURED.cover} overflow-hidden`}>
...
const MainTab = () => (
  <>
    <div className="vk-card p-4 flex flex-col md:flex-row gap-4 md:items-stretch">
      <div className="flex-1 min-w-0 vk-card bg-secondary/40 p-5 flex flex-col justify-between min-h-[260px]">
...
const MineTab = () => (
  <div className="vk-card p-12 text-center">
...
const ProfileTab = () => (
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
    <div className="vk-card p-5 min-h-[420px] flex flex-col">
    ...
    <div className="vk-card p-5 lg:col-span-2">
      <div className="flex items-center justify-between mb-3">
        <div>
      ...
      <div className="flex flex-col divide-y divide-border/60">
        {ACHIEVEMENTS.map((a) => (
          <div key={a.id} className="flex items-center gap-3 py-3">
            <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${a.cover} grayscale opacity-70`} />
            <div>
...
const Games = () => {
  ...
  return (
    <AppLayout variant="wide">
      <div className="vk-card p-3 flex items-center justify-between gap-3 flex-wrap">
