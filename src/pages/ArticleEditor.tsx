...
const ArticleEditor = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="sticky top-0 z-30 h-16 border-b border-border/60 bg-background/95 backdrop-blur flex items-center px-4 md:px-8">
        ...
        <div className="flex-1 flex items-center justify-center gap-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-vk-blue to-purple-500 flex items-center justify-center text-sm font-semibold">
              MR
            </div>
            <div>
          ...
          <div className="relative">
            ...
            {draftsOpen && (
              <div className="absolute right-0 mt-3 w-[420px] vk-card bg-popover border-border shadow-xl p-4 z-40">
          ...
          <div className="relative">
            ...
            {pubOpen && (
              <div className="absolute right-0 mt-3 w-[440px] vk-card bg-popover border-border shadow-xl p-5 z-40">
      ...
      {/* Editor body */}
      <div className="max-w-[760px] mx-auto px-4 md:px-8 py-12">
        <textarea
          value={title}
        ...
        <div className="relative">
          <textarea
            ...
            rows={6}
            className="w-full bg-transparent outline-none resize-none text-lg leading-relaxed placeholder:text-muted-foreground/60 min-h-[200px]"
          />
