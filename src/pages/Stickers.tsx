...
const SmallCover = ({ pack }: { pack: StickerPack }) => (
  <div className={cn("relative aspect-square rounded-2xl overflow-hidden bg-gradient-to-br", pack.cover)}>
...
const Stickers = () => {
  ...
  return (
    <AppLayout variant="wide">
      ...
      <div className="flex gap-3 overflow-x-auto pb-1 -mx-1 px-1 snap-x">
        {BANNERS.map((b, i) => (
          <div
            key={i}
            className={cn(
              "relative shrink-0 snap-start rounded-2xl overflow-hidden bg-gradient-to-br text-white",
              b.gradient,
              i === 0 ? "w-[180px] h-[260px]" : i === 1 ? "w-[640px] h-[260px]" : "w-[360px] h-[260px]",
            )}
          >
      ...
      {/* Search + Settings */}
      <div className="mt-4 vk-card p-2 flex items-center gap-2">
